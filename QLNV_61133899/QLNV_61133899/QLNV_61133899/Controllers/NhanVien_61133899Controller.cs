...
using QLNV_61133899.Models;

namespace QLNV_61133899.Controllers
{
    public class NhanVien_61133899Controller : Controller
    {
        private QLNV_61133899Entities db = new QLNV_61133899Entities();
        ...
        // tìm kiếm
        public ActionResult TimKiem_61133899()
        {
        ...
        public ActionResult TimKiem_61133899(string maNV = "", string hoTen = "", string gioiTinh = "", string luongMin = "", string luongMax = "", string diaChi = "", string maPB = "")
        {
        ...
        // GET: NhanVien_61133899/Details/5
        ...
        // GET: NhanVien_61133899/Delete/5
        ...
        // POST: NhanVien_61133899/Delete/5
